"""
Django settings for tyhio_dev_55599 project.
...
ROOT_URLCONF = 'tyhio_dev_55599.urls'
...
WSGI_APPLICATION = 'tyhio_dev_55599.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tyhio_dev_55599 API",
    "DESCRIPTION": "API documentation for tyhio_dev_55599 App",
    "VERSION": "v1",
}
